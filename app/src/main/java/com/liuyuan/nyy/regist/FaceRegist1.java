...
public class FaceRegist1 extends AppCompatActivity implements View.OnClickListener {

    private final static String TAG = FaceRegist1.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initUI();
        // 身份验证对象初始化
        mIdVerifier = IdentityVerifier.createVerifier(FaceRegist1.this, new InitListener() {
            @Override
        ...
        mToast = Toast.makeText(FaceRegist1.this, "", Toast.LENGTH_SHORT);
    }
    ...
    private void initUI() {
        ...
        mProDialog = new ProgressDialog(FaceRegist1.this);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_take_pic:
                //设置相机拍照后照片保存路径
                String savePath = "/sdcard/NYY/registFace/";
...
//                }
                ...
                if (!fileFolder.exists()) { // 如果目录不存在，则创建一个名为"registFace"的目录
                    fileFolder.mkdir();
                }
                mPictureFile = new File(fileFolder, "pic" + System.currentTimeMillis() / 1000 + ".jpg");
