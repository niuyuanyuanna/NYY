...
import com.liuyuan.nyy.util.SharedHelper;
...
public class RegistActivity extends AppCompatActivity
    ...
    private void intUi() {
        ...
        mBlurLockView.setBlurredView(findViewById(R.id.bluredview));
        ...
        mBlurLockView.setBlurRadius(16);
        mBlurLockView.setDownsampleFactor(10);
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_pwd_comfirm:
                ...
                if (TextUtils.isEmpty(password)) {
                    ...
                    SpeechApp.setmPassword(password);
                    showTip("密码已保存");
                    mSharedHelper.savePwd(password);
                }
                break;
            default:
                break;
    ...
    protected void onStart() {
        super.onStart();
        mGroupIDDrop.setText(mSharedHelper.readId());
        edt_pwd.setText(mSharedHelper.readPwd());
        edt_username.setText(mSharedHelper.readUname());
    }
